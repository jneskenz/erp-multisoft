        ...
        <div class="card-body">
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-1 d-flex align-items-end">
                    <button type="button" class="btn btn-outline-secondary" wire:click="$refresh" title="Actualizar">
                ...
                <div class="col-md-2">
                    <div class="d-flex gap-1">
                        ...
                        @can('locales.create')
                            <a href="{{ route('locales.create') }}" class="btn btn-primary" data-bs-toggle="tooltip" title="Crear nuevo local">
                        ...
                        <tbody>
                            @foreach ($locales as $local)
                                <tr>
                                    ...
                                    <td>
                                        <button type="button"
                                            class="btn btn-sm {{ $local->estado ? 'btn-success' : 'btn-secondary' }}"
                                            wire:click="toggleEstado({{ $local->id }})"
                                            title="{{ $local->estado ? 'Desactivar' : 'Activar' }}">
                                            <i class="bx bx-{{ $local->estado ? 'check' : 'x' }}"></i>
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('locales.show', $local) }}">
                                                        <i class="bx bx-show me-2"></i>Ver
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('locales.edit', $local) }}">
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    <div>
                        <small class="text-muted">
                            Mostrando {{ $locales->firstItem() ?? 0 }} - {{ $locales->lastItem() ?? 0 }}
